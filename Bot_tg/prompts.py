...
5.  **ВАЖНО: ВСЕ вопросы должны быть ТОЛЬКО типа `multiple_choice` с 4-5 вариантами ответа.**
6.  Для вопросов про возраст используй диапазоны (18-24, 25-34, 35-44, 45-54, 55+).
7.  Для вопросов про имя используй варианты типа: "Андрей/Александр", "Мария/Анна", "Дмитрий/Даниил", "Екатерина/Елена", "Другое имя (напишу в чате)".
...
[
  {{
    "question_text": "Привет! Как к тебе можно обращаться?",
    "type": "multiple_choice",
    "variants": ["Андрей", "Дмитрий", "Александр", "Максим", "Другое имя"]
  }},
  {{
...
<immediate_task>
Проанализируй профиль и сгенерируй JSON-анкету только для недостающей информации. **ИСПОЛЬЗУЙ ТОЛЬКО MULTIPLE CHOICE.**
</immediate_task>
"""
